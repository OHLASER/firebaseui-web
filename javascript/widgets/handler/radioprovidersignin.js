...
goog.provide('firebaseui.auth.widget.handler.handleRadioProviderSignIn');

goog.require('firebaseui.auth.ui.page.RadioProviderSignIn');
 ...
 */
firebaseui.auth.widget.handler.handleRadioProviderSignIn = function(
    app,
    container,
    infoBarMessage = undefined,
    email = undefined) {
  var component = new firebaseui.auth.ui.page.RadioProviderSignIn(
      function(providerId) {
...
firebaseui.auth.widget.handler.register(
    firebaseui.auth.widget.HandlerName.RADIO_PROVIDER_SIGN_IN,
    /** @type {firebaseui.auth.widget.Handler} */
    (firebaseui.auth.widget.handler.handleRadioProviderSignIn));
