...
goog.module('firebaseui.auth.ui.page.RadioProviderSignIn');
...
class RadioProviderSignIn extends Base {
  ...
  constructor(
    ...
    super(
        page.radioProviderSignIn,
        { providerConfigs }, domHelper, 'radioProviderSignIn', {
